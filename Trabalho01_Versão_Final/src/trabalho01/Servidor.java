...
import trabalho01.classes.Palestrante;
import trabalho01.classes.Participante;
import trabalho01.classes.Pessoa;
import trabalho01.classes.Turma;
...
public class Servidor {
    ...
    private static void buscarTodasTurma(PrintWriter writer) throws IOException{
        ...
        for (Turma t : turmas) {
            writer.println(t.getCodigo()+ " - " + t.getDescricao() + " - " + t.getPessoas());
        }
    }
